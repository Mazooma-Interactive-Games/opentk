...
#if XAMCORE_2_0
using libXam.CoreAnimation;
using libXam.CoreGraphics;
...
#if XAMCORE_2_0
using RectangleF = libXam.CoreGraphics.CGRect;
using SizeF = libXam.CoreGraphics.CGSize;
#endif
...
namespace OpenTK.Platform.iPhoneOS
{
    ...
    public class iPhoneOSGameView : UIView, IGameWindow
    {
     ...
     [Export("layerClass")]
        ...
        public virtual void MakeNotCurrent()
        {
            AssertValid();
            AssertContext();
            GraphicsContext.MakeCurrent(WindowInfo);
