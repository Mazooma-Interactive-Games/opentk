...
namespace OpenTK.Platform.Windows
{
    ...
    /// \internal 
    /// <summary>
    /// For internal use by OpenTK only! Exposes useful native WINAPI methods and structures.
    /// </summary>
    ...
    internal static class Functions
    {
        ...
        // WINUSERAPI BOOL WINAPI SetWindowPos(__in HWND hWnd, __in_opt HWND hWndInsertAfter, __in
        // int X, __in int Y, __in int cx, __in int cy, __in UINT uFlags);
        ...
        /// structure contains the coordinates of the top-left and bottom-right corners of the
        /// window to accommodate the desired client area.
        /// </param>
        /// <param name="dwStyle">
        ...
        /// includes the client area and the nonclient area. The AdjustWindowRect function does not
        /// add extra space when a menu bar wraps to two or more rows. The AdjustWindowRect function
        /// does not take the WS_VSCROLL or WS_HSCROLL styles into account. To account for the
        /// scroll bars, call the GetSystemMetrics function with SM_CXVSCROLL or SM_CYHSCROLL. Found
        ...
        */
        ...
        #endregion CallWindowProc

        #region SetWindowLong

        // SetWindowLongPtr does not exist on x86 platforms (it's a macro that resolves to
        // SetWindowLong) . We need to detect if we are on x86 or x64 at runtime and call the correct
        // function (SetWindowLongPtr on x64 or SetWindowLong on x86). Fun!
        internal static IntPtr SetWindowLong(IntPtr handle, GetWindowLongOffsets item, IntPtr newValue)
        {
            // SetWindowPos defines its error condition as an IntPtr.Zero retval and a non-0
            // GetLastError. We need to SetLastError(0) to ensure we are not detecting on older
            // error condition (from another function).
        ...
        #endregion CreateWindowEx

        #region Message handling

        #region PeekMessage

        /// <summary> Low-level WINAPI function that checks the next message in the queue. </summary>
        ...
        /// <summary> Low-level WINAPI function that retrieves the next message in the queue. </summary>
        /// <param name="msg">              The pending message (if any) is stored here. </param>
        /// <param name="windowHandle">     Not used </param>
        /// <param name="messageFilterMin"> Not used </param>
        /// <param name="messageFilterMax"> Not used </param>
        /// <returns>
        /// Nonzero indicates that the function retrieves a message other than WM_QUIT. Zero
        /// indicates that the function retrieves the WM_QUIT message, or that lpMsg is an invalid
        /// pointer. 1 indicates that an error occurred  for example, the function fails if hWnd
        /// is an invalid window handle. To get extended error information, call GetLastError.
        /// </returns>
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("User32.dll"), CLSCompliant(false)]
        //[return: MarshalAs(UnmanagedType.Bool)]
        ...
        /// The time is a long integer that specifies the elapsed time, in milliseconds, from the
        /// time the system was started to the time the message was created (that is, placed in the
        ...
        /// <returns>
        /// The high-order word of the return value indicates the types of messages currently in the
        /// queue. The low-order word indicates the types of messages that have been added to the
        /// queue and that are still in the queue since the last call to the GetQueueStatus,
        /// GetMessage, or PeekMessage function.
        /// </returns>
        /// <remarks>
        /// The presence of a QS_ flag in the return value does not guarantee that a subsequent call
        /// to the GetMessage or PeekMessage function will return a message. GetMessage and
        /// PeekMessage perform some internal filtering that may cause the message to be processed
        /// internally. For this reason, the return value from GetQueueStatus should be considered
        /// only a hint as to whether GetMessage or PeekMessage should be called.
        /// <para>
        /// The QS_ALLPOSTMESSAGE and QS_POSTMESSAGE flags differ in when they are cleared.
        /// QS_POSTMESSAGE is cleared when you call GetMessage or PeekMessage, whether or not you
        /// are filtering messages. QS_ALLPOSTMESSAGE is cleared when you call GetMessage or
        /// PeekMessage without filtering messages (wMsgFilterMin and wMsgFilterMax are 0). This can
        /// be useful when you call PeekMessage multiple times to get messages in different ranges.
        /// </para>
        /// </remarks>
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("User32.dll", CharSet = CharSet.Unicode)]
        ...
        /// <summary> Sets the timing resolution of the GetTime (?) method. </summary>
        ...
        /// <summary> The ShowWindow function sets the specified window's show state. </summary>
        /// <param name="hWnd">     [in] Handle to the window. </param>
        /// <param name="nCmdShow">
        /// [in] Specifies how the window is to be shown. This parameter is ignored the first time
        /// an application calls ShowWindow, if the program that launched the application provides a
        ...
        /// </para>
        /// <list type=""> <item> Applications create their main window by calling CreateWindow with
        /// the WS_VISIBLE flag set. </item><item> Applications create their main window by calling
        /// CreateWindow with the WS_VISIBLE flag cleared, and later call ShowWindow with the
        /// SW_SHOW flag set to make it visible. </item></list>
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true), SuppressUnmanagedCodeSecurity]
        ...
        /// message to be sent to the specified window or control. If the control is a list box
        /// control created with the WS_CAPTION style, however, SetWindowText sets the text for the
        ...
        /// </para>
        /// <para>
        /// Windows 95/98/Me: SetWindowTextW is supported by the Microsoft Layer for Unicode (MSLU).
        /// To use this, you must add certain files to your application, as outlined in Microsoft
        ...
        /// has one) into a buffer. If the specified window is a control, the text of the control is
        /// copied. However, GetWindowText cannot retrieve the text of a control in another application.
        /// </summary>
        /// <param name="hWnd">      [in] Handle to the window or control containing the text. </param>
        /// <param name="lpString"> 
        /// [out] Pointer to the buffer that will receive the text. If the string is as long or
        /// longer than the buffer, the string is truncated and terminated with a NULL character.
        /// </param>
        /// <param name="nMaxCount">
        /// [in] Specifies the maximum number of characters to copy to the buffer, including the
        ...
        /// <remarks>
        /// <para>
        /// If the target window is owned by the current process, GetWindowText causes a WM_GETTEXT
        /// message to be sent to the specified window or control. If the target window is owned by
        /// another process and has a caption, GetWindowText retrieves the window caption text. If
        /// the window does not have a caption, the return value is a null string. This behavior is
        /// by design. It allows applications to call GetWindowText without becoming unresponsive if
        /// the process that owns the target window is not responding. However, if the target window
        /// is not responding and it belongs to the calling application, GetWindowText will cause
        /// the calling application to become unresponsive.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// Windows 95/98/Me: GetWindowTextW is supported by the Microsoft Layer for Unicode (MSLU).
        /// To use this, you must add certain files to your application, as outlined in Microsoft
        /// Layer for Unicode on Windows 95/98/Me
        /// </para>
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        ...
        /// <returns>
        /// If the function succeeds, the return value is nonzero. If the function fails, the return
        /// value is zero. Windows NT/2000/XP: To get extended error information, call GetLastError.
        /// </returns>
        /// <remarks>
        /// <para>
        /// The function uses the window identified by the hWnd parameter and the screen coordinates
        /// given in the POINT structure to compute client coordinates. It then replaces the screen
        /// coordinates with the client coordinates. The new coordinates are relative to the
        /// upper-left corner of the specified window's client area.
        /// </para>
        ...
        /// <para>
        /// Do not use ScreenToClient when in a mirroring situation, that is, when changing from
        /// left-to-right layout to right-to-left layout. Instead, use MapWindowPoints. For more
        /// information, see "Window Layout and Mirroring" in Window Features.
        /// </para>
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true), SuppressUnmanagedCodeSecurity]
        ...
        /// </param>
        /// <param name="point">
        /// Pointer to a POINT structure that contains the client coordinates to be converted. The
        ...
        /// <remarks>
        /// <para>
        /// The ClientToScreen function replaces the client-area coordinates in the POINT structure
        /// with the screen coordinates. The screen coordinates are relative to the upper-left
        /// corner of the screen. Note, a screen-coordinate point that is above the window's client
        /// area has a negative y-coordinate. Similarly, a screen coordinate to the left of a client
        ...
        #endregion ClientToScreen

        #region GetClientRect

        /// <summary>
        /// The GetClientRect function retrieves the coordinates of a window's client area. The
        ...
        /// </returns>
        /// <remarks>
        /// The system copies the bitmaps in the IconInfo structure before creating the icon or
        /// cursor. Because the system may temporarily select the bitmaps in a device context, the
        /// hbmMask and hbmColor members of the IconInfo structure should not already be selected
        /// into a device context. The application must continue to manage the original bitmaps and
        /// delete them when they are no longer necessary. When you are finished using the icon,
        /// destroy it using the DestroyIcon function.
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true)]
        public static extern HICON CreateIconIndirect(ref IconInfo iconInfo);

        #endregion CreateIconIndirect
        ...
        /// </param>
        /// <returns>
        /// If the function succeeds, the return value is nonzero and the function fills in the
        ...
        /// </returns>
        /// <remarks>
        /// GetIconInfo creates bitmaps for the hbmMask and hbmColor members of IconInfo. The
        ...
        /// </returns>
        /// <remarks>
        /// It is only necessary to call DestroyIcon for icons and cursors created with the
        /// following functions: CreateIconFromResourceEx (if called without the LR_SHARED flag),
        /// CreateIconIndirect, and CopyIcon. Do not use this function to destroy a shared icon. A
        /// shared icon is valid as long as the module from which it was loaded remains in memory.
        /// The following functions obtain a shared icon.
        /// 
        /// LoadIcon LoadImage (if you use the LR_SHARED flag) CopyImage (if you use the
        /// LR_COPYRETURNORG flag and the hImage parameter is a shared icon) CreateIconFromResource
        ...
        /// <summary>
        /// The ChangeDisplaySettings function changes the settings of the default display device to
        /// the specified graphics mode.
        /// </summary>
        /// <param name="device_mode">
        /// [in] Pointer to a DEVMODE structure that describes the new graphics mode. If lpDevMode
        /// is NULL, all the values currently in the registry will be used for the display setting.
        /// Passing NULL for the lpDevMode parameter and 0 for the dwFlags parameter is the easiest
        ...
        #endregion ChangeDisplaySettingsEx
        ...
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern BOOL EnumDisplaySettingsExA([MarshalAs(UnmanagedType.LPTStr)] LPCTSTR lpszDeviceName, DisplayModeSettingsEnum iModeNum,
            [In, Out] DeviceMode lpDevMode, DWORD dwFlags);
        ...
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall)]
        public static extern BOOL EnumDisplaySettingsExW([MarshalAs(UnmanagedType.LPTStr)] LPCTSTR lpszDeviceName, DWORD iModeNum,
            [In, Out] DeviceMode lpDevMode, DWORD dwFlags);
        ...
        /// </returns>
        /// <remarks>
        /// DLLs should accept the dpi setting of the host process rather than call
        /// SetProcessDPIAware themselves. To be set properly, dpiAware should be specified as part
        ...
        /// <param name="pointsIn">       
        /// A pointer to a MOUSEMOVEPOINT structure containing valid mouse coordinates (in screen
        /// coordinates) . It may also contain a time stamp.
        /// </param>
        /// <param name="pointsBufferOut">
        /// A pointer to a buffer that will receive the points. It should be at least cbSize *
        /// nBufPoints in size.
        /// </param>
        /// <param name="nBufPoints">      The number of points to be retrieved. </param>
        /// <param name="resolution">     
        /// The resolution desired. This parameter can GMMP_USE_DISPLAY_POINTS or GMMP_USE_HIGH_RESOLUTION_POINTS.
        /// </param>
        /// <returns></returns>
        ...
        /// or loaded by the LoadCursor or LoadImage function. If this parameter is IntPtr.Zero, the
        ...
        /// 
        /// The cursor is a shared resource. A window should set the cursor shape only when the
        /// cursor is in its client area or when the window is capturing mouse input. In systems
        /// without a mouse, the window should restore the previous cursor before the cursor leaves
        /// the client area or before it relinquishes control to another window.
        /// 
        /// If your application must set the cursor while it is in a window, make sure the class
        /// cursor for the specified window's class is set to NULL. If the class cursor is not NULL,
        /// the system restores the class cursor each time the mouse is moved.
        /// 
        /// The cursor is not shown on the screen if the internal cursor display count is less than
        /// zero. This occurs if the application uses the ShowCursor function to hide the cursor
        /// more times than to show the cursor.
        /// </remarks>
        [DllImport("user32.dll")]
        ...
        /// <returns>
        /// The return value is the handle to the current cursor. If there is no cursor, the return
        /// value is null.
        /// </returns>
        [DllImport("user32.dll")]
        ...
        /// mapping mode of the window that contains the cursor.
        /// </para>
        ...
        /// not, call SetThreadDesktop with the HDESK returned by OpenInputDesktop to switch to that desktop.
        /// </para>
        /// </remarks>
        [DllImport("user32.dll", SetLastError = true), SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        /// calls the default raw input procedure to provide default processing for any raw input
        /// messages that an application does not process. This function ensures that every message
        /// is processed. DefRawInputProc is called with the same parameters received by the window procedure.
        /// </summary>
        ...
        /// Pointer to an array of RawInputDevice structures that represent the devices that supply
        /// the raw input.
        /// </param>
        /// <param name="NumDevices">     
        /// Number of RawInputDevice structures pointed to by RawInputDevices.
        /// </param>
        /// <param name="Size">            Size, in bytes, of a RAWINPUTDEVICE structure. </param>
        /// <returns>
        ...
        /// <param name="Data">      
        /// Pointer to a buffer of RawInput structures that contain the raw input data. If NULL, the
        /// minimum required buffer, in bytes, is returned in Size.
        /// </param>
        /// <param name="Size">      
        ...
        /// <returns>
        /// If Data is NULL and the function is successful, the return value is zero. If Data is not
        /// NULL and the function is successful, the return value is the number of RawInput
        /// structures written to Data. If an error occurs, the return value is (UINT)-1. Call
        ...
        /// </param>
        /// <param name="NumDevices">      Number of RawInputDevice structures in RawInputDevices. </param>
        /// <param name="cbSize">          Size, in bytes, of a RawInputDevice structure. </param>
        /// <returns>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// If the pRawInputDevices buffer is too small or NULL, the function sets the last error as
        /// ERROR_INSUFFICIENT_BUFFER, returns -1, and sets NumDevices to the required number of devices.
        /// </para>
        /// <para>
        ...
        /// ointer to buffer that holds an array of RawInputDeviceList structures for the devices
        /// attached to the system. If NULL, the number of devices are returned in NumDevices.
        /// </param>
        /// <param name="NumDevices">        
        /// Pointer to a variable. If RawInputDeviceList is NULL, it specifies the number of devices
        /// attached to the system. Otherwise, it contains the size, in bytes, of the preallocated
        /// buffer pointed to by pRawInputDeviceList. However, if NumDevices is smaller than needed
        /// to contain RawInputDeviceList structures, the required buffer size is returned here.
        /// </param>
        /// <param name="Size">               Size of a RawInputDeviceList structure. </param>
        /// <returns>
        /// If the function is successful, the return value is the number of devices stored in the
        /// buffer pointed to by RawInputDeviceList. If RawInputDeviceList is NULL, the return value
        /// is zero. If NumDevices is smaller than needed to contain all the RawInputDeviceList
        /// structures, the return value is (UINT) -1 and the required buffer is returned in
        /// NumDevices. Calling GetLastError returns ERROR_INSUFFICIENT_BUFFER. On any other error,
        /// the function returns (UINT) -1 and GetLastError returns the error indication.
        /// </returns>
        [CLSCompliant(false)]
        [DllImport("user32.dll", SetLastError = true)]
        ...
        /// <param name="Device"> 
        /// Handle to the raw input device. This comes from the lParam of the WM_INPUT message, from
        /// RawInputHeader.Device, or from GetRawInputDeviceList. It can also be NULL if an
        /// application inserts input data, for example, by using SendInput.
        /// </param>
        /// <param name="Command">
        /// Specifies what data will be returned in pData. It can be one of the following values.
        /// RawInputDeviceInfoEnum.PREPARSEDDATA Data points to the previously parsed data.
        /// RawInputDeviceInfoEnum.DEVICENAME Data points to a string that contains the device name.
        /// For this Command only, the value in Size is the character count (not the byte count).
        /// RawInputDeviceInfoEnum.DEVICEINFO Data points to an RawInputDeviceInfo structure.
        /// </param>
        /// <param name="Data">   
        /// ointer to a buffer that contains the information specified by Command. If Command is
        /// RawInputDeviceInfoEnum.DEVICEINFO, set RawInputDeviceInfo.Size to
        /// sizeof(RawInputDeviceInfo) before calling GetRawInputDeviceInfo. (This is done
        /// automatically in OpenTK)
        /// </param>
        /// <param name="Size">   
        ...
        /// bytes copied to Data.
        /// </para>
        /// <para>
        /// If Data is not large enough for the data, the function returns -1. If Data is NULL, the
        /// function returns a value of zero. In both of these cases, Size is set to the minimum
        /// size required for the Data buffer.
        /// </para>
        ...
        /// </param>
        /// <param name="Command">   
        /// Command flag. This parameter can be one of the following values. RawInputDateEnum.INPUT
        /// Get the raw data from the RawInput structure. RawInputDateEnum.HEADER Get the header
        /// information from the RawInput structure.
        /// </param>
        /// <param name="Data">      
        /// Pointer to the data that comes from the RawInput structure. This depends on the value of
        /// uiCommand. If Data is NULL, the required size of the buffer is returned in Size.
        /// </param>
        /// <param name="Size">      
        ...
        /// <returns>
        /// <para>
        /// If Data is NULL and the function is successful, the return value is 0. If Data is not
        /// NULL and the function is successful, the return value is the number of bytes copied into Data.
        /// </para>
        ...
        */
        ...
        #endregion IntPtr NextRawInputStructure(IntPtr data)
    ...
    internal static class Constants
    {
        ...
        /// <summary>
        /// Retrieves high resolution points. Points can range from zero to 65,535 (0xFFFF) in both
        /// x and y coordinates. This is the resolution provided by absolute coordinate pointing
    ...
    {
        /// <summary> Contains additional data which may be used to create the window. </summary>
        /// <remarks>
        /// If the window is being created as a result of a call to the CreateWindow or
        /// CreateWindowEx function, this member contains the value of the lpParam parameter
        /// specified in the function call.
        /// <para>
        /// If the window being created is a multiple-document interface (MDI) client window, this
        /// member contains a pointer to a CLIENTCREATESTRUCT structure. If the window being created
        /// is a MDI child window, this member contains a pointer to an MDICREATESTRUCT structure.
        /// </para>
        /// <para>
        /// Windows NT/2000/XP: If the window is being created from a dialog template, this member
        /// is the address of a SHORT value that specifies the size, in bytes, of the window
        /// creation data. The value is immediately followed by the creation data.
        /// </para>
        /// <para>
        /// Windows NT/2000/XP: You should access the data represented by the lpCreateParams member
        /// using a pointer that has been declared using the UNALIGNED type, because the pointer may
        /// not be DWORD aligned.
        /// </para>
        /// </remarks>
        internal LPVOID lpCreateParams;

        /// <summary> Handle to the module that owns the new window. </summary>
        internal HINSTANCE hInstance;

        /// <summary> Handle to the menu to be used by the new window. </summary>
        internal HMENU hMenu;

        /// <summary>
        /// Handle to the parent window, if the window is a child window. If the window is owned,
        /// this member identifies the owner window. If the window is not a child or owned window,
        /// this member is NULL.
        /// </summary>
        internal HWND hwndParent;

        /// <summary> Specifies the height of the new window, in pixels. </summary>
        internal int cy;

        /// <summary> Specifies the width of the new window, in pixels. </summary>
        internal int cx;

        /// <summary>
        /// Specifies the y-coordinate of the upper left corner of the new window. If the new window
        /// is a child window, coordinates are relative to the parent window. Otherwise, the
        /// coordinates are relative to the screen origin.
        /// </summary>
        internal int y;

        /// <summary>
        /// Specifies the x-coordinate of the upper left corner of the new window. If the new window
        /// is a child window, coordinates are relative to the parent window. Otherwise, the
        /// coordinates are relative to the screen origin.
        /// </summary>
        internal int x;

        /// <summary> Specifies the style for the new window. </summary>
        internal LONG style;
        ...
        /// <summary>
        /// Either a pointer to a null-terminated string or an atom that specifies the class name of
        /// the new window. <remarks> Note Because the lpszClass member can contain a pointer to a
        /// local (and thus inaccessable) atom, do not obtain the class name by using this member.
        /// Use the GetClassName function instead. </remarks>
        /// </summary>
        [MarshalAs(UnmanagedType.LPTStr)]
        internal LPCTSTR lpszClass;

        /// <summary> Specifies the extended window style for the new window. </summary>
        internal DWORD dwExStyle;
    }

    #endregion CreateStruct
    ...
    #endregion ExtendedStyleStruct

    #region PixelFormatDescriptor

    /// \internal 
    /// <summary>
    /// Describes a pixel format. It is used when interfacing with the WINAPI to create a new
    /// Context. Found in WinGDI.h
    /// </summary>
    ...
    #endregion PixelFormatDescriptor

    #region internal class LayerPlaneDescriptor

    /// \internal 
    /// <summary> Describes the pixel format of a drawing surface. </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    #endregion internal class LayerPlaneDescriptor

    #region GlyphMetricsFloat

    /// \internal 
    /// <summary>
    /// The <b> GlyphMetricsFloat </b> structure contains information about the placement and
    ...
    {
        /// <summary>
        /// Specifies the width of the smallest rectangle (the glyph's black box) that completely
        /// encloses the glyph.
        /// </summary>
        internal float BlackBoxX;

        /// <summary>
        /// Specifies the height of the smallest rectangle (the glyph's black box) that completely
        /// encloses the glyph.
        /// </summary>
    ...
    #endregion GlyphMetricsFloat

    #region PointFloat

    /// \internal 
    /// <summary> The <b> PointFloat </b> structure contains the x and y coordinates of a point. </summary>
    ...
    */
    ...
    internal class DeviceMode
    {
        ...
        internal Int16 SpecVersion;
        [MarshalAs(UnmanagedType.U2)]
        internal Int16 DriverVersion;
        [MarshalAs(UnmanagedType.U2)]
        internal Int16 Size;
        [MarshalAs(UnmanagedType.U2)]
        internal Int16 DriverExtra;
        [MarshalAs(UnmanagedType.U4)]
        internal Int32 Fields;
    ...
    #endregion ExtendedWindowClass

    #region internal struct MinMaxInfo

    /// \internal 
    /// <summary> Struct pointed to by WM_GETMINMAXINFO lParam </summary>
    [StructLayout(LayoutKind.Sequential)]
    ...
    #endregion internal struct MinMaxInfo
    ...
    internal struct WindowPosition
    {
        ...
        /// <summary>
        /// Specifies the position of the window in Z order (front-to-back position). This member
        /// can be a handle to the window behind which this window is placed, or can be one of the
        /// special values listed with the SetWindowPos function.
        /// </summary>
        ...
        /// <summary> Specifies the window position. </summary>
        [MarshalAs(UnmanagedType.U4)]
    ...
    #endregion internal enum SetWindowPosFlags

    #endregion internal struct WindowPosition
    ...
    internal struct RawInputDevice
    {
        ...
        /// <summary>
        /// Mode flag that specifies how to interpret the information provided by UsagePage and
        /// Usage. It can be zero (the default) or one of the following values. By default, the
        /// operating system sends raw input from devices with the specified top level collection
    ...
    /// <remarks> To get more information on the device, use hDevice in a call to GetRawInputDeviceInfo. </remarks>
    [StructLayout(LayoutKind.Sequential)]
    internal struct RawInputHeader
    {
        /// <summary> Type of raw input. </summary>
        internal RawInputDeviceType Type;

        /// <summary>
        /// Size, in bytes, of the entire input packet of data. This includes the RawInput struct
        /// plus possible extra input reports in the RAWHID variable length array.
        /// </summary>
        internal DWORD Size;
        ...
        /// <summary> Value passed in the wParam parameter of the WM_INPUT message. </summary>
        internal WPARAM Param;
    }

    #endregion RawInputHeader
    ...
    internal struct RawKeyboard
    {
        ...
        /// <summary>
        /// Flags for scan code information. It can be one or more of the following. RI_KEY_MAKE
        /// RI_KEY_BREAK RI_KEY_E0 RI_KEY_E1 RI_KEY_TERMSRV_SET_LED RI_KEY_TERMSRV_SHADOW
        /// </summary>
    ...
    internal struct RawMouse
    {
        ...
        /// MOUSE_ATTRIBUTES_CHANGED Mouse attributes changed; application needs to query the mouse
        /// attributes. MOUSE_MOVE_RELATIVE Mouse movement data is relative to the last mouse
        /// position. MOUSE_MOVE_ABSOLUTE Mouse movement data is based on absolute position.
        /// MOUSE_VIRTUAL_DESKTOP Mouse coordinates are mapped to the virtual desktop (for a
        ...
        /// <summary>
        /// If usButtonFlags is RI_MOUSE_WHEEL, this member is a signed value that specifies the
        /// wheel delta.
        /// </summary>
        [FieldOffset(6)]
        ...
        /// <summary>
        /// Motion in the X direction. This is signed relative motion or absolute motion, depending
        ...
        /// <summary>
        /// Motion in the Y direction. This is signed relative motion or absolute motion, depending
        /// on the value of usFlags.
        /// </summary>
        [FieldOffset(16)]
        public LONG LastY;
    ...
    internal struct RawMouse
    {
        ...
        /// <summary> Transition state of the mouse buttons. </summary>
    ...
    /// </summary>
    /// <remarks>
    /// Each WM_INPUT can indicate several inputs, but all of the inputs come from the same HID. The
    /// size of the bRawData array is dwSizeHid * dwCount.
    /// </remarks>
    [StructLayout(LayoutKind.Sequential)]
    internal struct RawHID
    {
        /// <summary> Size, in bytes, of each HID input in bRawData. </summary>
        internal DWORD SizeHid;

        /// <summary> Number of HID inputs in bRawData. </summary>
    ...
    {
        /// <summary> Size, in bytes, of the RawInputDeviceInfo structure. </summary>
        private DWORD Size = Marshal.SizeOf(typeof(RawInputDeviceInfo));

        /// <summary> Type of raw input data. </summary>
        internal RawInputDeviceType Type;
    ...
    #endregion RawInputHIDDeviceInfo
    ...
    #endregion RawInputKeyboardDeviceInfo
    ...
    #endregion RawInputMouseDeviceInfo

    #endregion Raw Input structures
    ...
    /// exclusive. In other words, the pixel whose coordinates are (right, bottom) lies immediately
    /// outside of the the rectangle. For example, when RECT is passed to the FillRect function, the
    /// rectangle is filled up to, but not including, the right column and bottom row of pixels.
    ...
    internal struct WindowInfo
    {
        ...
        /// <summary> Pointer to a RECT structure that specifies the coordinates of the window. </summary>
        public RECT Window;
        ...
        /// <summary> The window styles. For a table of window styles, see CreateWindowEx. </summary>
        ...
        /// <summary>
        /// The window status. If this member is WS_ACTIVECAPTION, the window is active. Otherwise,
        /// this member is zero.
        /// </summary>
        ...
        /// <summary> The Microsoft Windows version of the application that created the window. </summary>
    ...
    #endregion TrackMouseEventStructure
    ...
    #endregion BroadcastDeviceInterface
    ...
    public struct MouseMovePoint
    {
        ...
        /// <summary> The time stamp of the mouse coordinate. </summary>
        public int Time;

        /// <summary> Additional information associated with this coordinate. </summary>
        public IntPtr ExtraInfo;

        public static readonly int SizeInBytes = Marshal.SizeOf(default(MouseMovePoint));
    }

    #endregion MouseMovePoint
    ...
    internal struct IconInfo
    {
        ...
        /// <summary>
        /// The x-coordinate of a cursor's hot spot. If this structure defines an icon, the hot spot
        /// is always in the center of the icon, and this member is ignored.
        /// </summary>
        public Int32 xHotspot;

        /// <summary>
        /// The y-coordinate of a cursor's hot spot. If this structure defines an icon, the hot spot
        /// is always in the center of the icon, and this member is ignored.
        /// </summary>
        ...
        /// is formatted so that the upper half is the icon AND bitmask and the lower half is the
        /// icon XOR bitmask. Under this condition, the height should be an even multiple of two. If
        ...
        /// a black and white icon. The AND bitmask of hbmMask is applied with the SRCAND flag to
    ...
    /// <summary> Window field offsets for GetWindowLong() and GetWindowLongPtr(). </summary>
    internal enum GWL
    {
        WNDPROC = (-4),
        HINSTANCE = (-6),
    ...
    #endregion internal enum DisplayModeSettingsEnum
    ...
    #endregion internal enum DisplayDeviceStateFlags
    ...
    #endregion internal enum ChangeDisplaySettingsEnum
    ...
    #endregion internal enum WindowStyle : uint
    ...
    #endregion internal enum ExtendedWindowStyle : uint
    ...
    #endregion GetWindowLongOffsets enum
    ...
    #endregion PixelFormatDescriptorFlags enum
    ...
    #endregion WindowPlacementOptions enum
    ...
    {
        /// <summary>
        /// If set, this removes the top level collection from the inclusion list. This tells the
        /// operating system to stop reading from a device which matches the top level collection.
        /// </summary>
        REMOVE = 0x00000001,

        /// <summary>
        /// If set, this specifies the top level collections to exclude when reading a complete
        /// usage page. This flag only affects a TLC whose usage page is already specified with RawInputDeviceEnum.PAGEONLY.
        /// </summary>
        EXCLUDE = 0x00000010,

        /// <summary>
        /// If set, this specifies all devices whose top level collection is from the specified
        /// UsagePage. Note that usUsage must be zero. To exclude a particular top level collection,
        /// use EXCLUDE.
        /// </summary>
        PAGEONLY = 0x00000020,

        /// <summary>
        /// If set, this prevents any devices specified by UsagePage or Usage from generating legacy
        /// messages. This is only for the mouse and keyboard. See RawInputDevice Remarks.
        /// </summary>
        NOLEGACY = 0x00000030,

        /// <summary>
        /// If set, this enables the caller to receive the input even when the caller is not in the
        /// foreground. Note that Target must be specified in RawInputDevice.
        /// </summary>
        ...
        /// <summary>
        /// If set, the application-defined keyboard device hotkeys are not handled. However, the
        /// system hotkeys; for example, ALT+TAB and CTRL+ALT+DEL, are still handled. By default,
        /// all keyboard hotkeys are handled. NOHOTKEYS can be specified even if NOLEGACY is not
        /// specified and Target is NULL in RawInputDevice.
        /// </summary>
        NOHOTKEYS = 0x00000200, // effective for keyboard.

        /// <summary>
        /// Microsoft Windows XP Service Pack 1 (SP1): If set, the application command keys are
        /// handled. APPKEYS can be specified only if NOLEGACY is specified for a keyboard device.
        /// </summary>
        APPKEYS = 0x00000400, // effective for keyboard.

        /// <summary>
        /// If set, this enables the caller to receive input in the background only if the
        /// foreground application does not process it. In other words, if the foreground
    ...
    #endregion RawInputDeviceFlags enum
    ...
    #endregion RawInputDeviceInfoEnum
    ...
    #endregion RawInputKeyboardDataFlags
    ...
    #endregion RawInputDeviceType

    #region RawMouseFlags

    /// <summary> Mouse indicator flags (found in winuser.h). </summary>
    [Flags]
    internal enum RawMouseFlags : ushort
    {
        /// <summary> LastX/Y indicate relative motion. </summary>
        MOUSE_MOVE_RELATIVE = 0x00,

        /// <summary> LastX/Y indicate absolute motion. </summary>
        MOUSE_MOVE_ABSOLUTE = 0x01,

        /// <summary> The coordinates are mapped to the virtual desktop. </summary>
        MOUSE_VIRTUAL_DESKTOP = 0x02,

        /// <summary> Requery for mouse attributes. </summary>
        MOUSE_ATTRIBUTES_CHANGED = 0x04,
    }

    #endregion RawMouseFlags
    ...
    #endregion VirtualKeys

    #region MouseKeys

    /// <summary> Enumerates available mouse keys (suitable for use in WM_MOUSEMOVE messages). </summary>
    internal enum MouseKeys
    {
        // Summary: No mouse button was pressed. 
        None = 0,

        // Summary: The left mouse button was pressed. 
        Left = 0x0001,
    ...
    /// \internal 
    /// <summary> Queue status flags for GetQueueStatus() and MsgWaitForMultipleObjects() </summary>
    [Flags]
    internal enum QueueStatusFlags
    {
        ...
        /// <summary>
        /// A raw input message is in the queue. For more information, see Raw Input. Windows XP and
        /// higher only.
        /// </summary>
        RAWINPUT = 0x0400,
        ...
        /// <summary>
        /// An input message is in the queue. This is composed of KEY, MOUSE and RAWINPUT. Windows
        /// XP and higher only.
        /// </summary>
        INPUT = MOUSE | KEY | RAWINPUT,

        /// <summary>
        /// An input message is in the queue. This is composed of QS_KEY and QS_MOUSE. Windows 2000
        /// and earlier.
        /// </summary>
    ...
    public enum WindowMessage : int
    {
        ...
        // internal const uint FILESYSCHANGE = 0x0034; internal const uint ISACTIVEICON = 0x0035;
        // internal const uint QUERYPARKICON = 0x0036;
        QUERYDRAGICON = 0x0037,

        COMPAREITEM = 0x0039,

        // internal const uint TESTING = 0x003a; internal const uint OTHERWINDOWCREATED = 0x003c; 
        GETOBJECT = 0x003D,
        ...
        /// <summary> Windows 2000 and higher only. </summary>
        ...
        /// <summary> Windows Vista and higher only. </summary>
        MOUSEHWHEEL = 0x020E,
        ...
        // internal const uint DROPOBJECT = 0x022A; internal const uint QUERYDROPOBJECT = 0x022B;
        // internal const uint BEGINDRAG = 0x022C; internal const uint DRAGLOOP = 0x022D; internal
        // const uint DRAGSELECT = 0x022E; internal const uint DRAGMOVE = 0x022F;
        MDISETMENU = 0x0230,
    ...
    /// <summary> Identifiers for the WM_SHOWWINDOW message </summary>
    ...
    #endregion ShowWindowMessageIdentifiers

    #region GDI charset

    /// <summary> Enumerates the available character sets. </summary>
    ...
    {
        /// <summary>
        /// uCode is a virtual-key code and is translated into a scan code. If it is a virtual-key
        /// code that does not distinguish between left- and right-hand keys, the left-hand scan
        /// code is returned. If there is no translation, the function returns 0.
        /// </summary>
        VirtualKeyToScanCode = 0,

        /// <summary>
        /// uCode is a scan code and is translated into a virtual-key code that does not distinguish
        /// between left- and right-hand keys. If there is no translation, the function returns 0.
        /// </summary>
        ScanCodeToVirtualKey = 1,

        /// <summary>
        /// uCode is a virtual-key code and is translated into an unshifted character value in the
        ...
        /// <summary>
        /// Windows NT/2000/XP: uCode is a scan code and is translated into a virtual-key code that
        /// distinguishes between left- and right-hand keys. If there is no translation, the
        /// function returns 0.
        /// </summary>
